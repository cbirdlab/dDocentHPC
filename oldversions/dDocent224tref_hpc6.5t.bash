...
#CEB this is a test 2-6-2018 - we temporarily commented out this code as a test of filtering secondary alignment
#samtools merge -@$NUMProc -b bamlist.$CUTOFF.$CUTOFF2.list -f cat.$CUTOFF.$CUTOFF2-RRG.bam &>/dev/null

#CEB this is a test 2-6-2018 - we inserted this code as a test of filtering secondary alignment
samtools view -@$NUMProc -F 0x100 -SbT reference.$CUTOFF.$CUTOFF2.fasta cat.$CUTOFF.$CUTOFF2-RRG-test.bam > cat.$CUTOFF.$CUTOFF2-RRG.bam 
